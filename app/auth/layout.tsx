      ...
      <div className="relative hidden lg:flex h-full flex-col bg-muted p-10 text-white">
        ...
        <div className="z-20 flex items-center gap-2">
          ...
          <div className="text-white">
            <h1 className="text-lg font-extrabold">Swarnim Publication Pvt. Ltd.</h1>
            <h4 className="font-bold">publicationswarnim@gmail.com</h4>
          </div>
        </div>
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            ...
            <footer className="text-sm">Created By EducationFirm</footer>
          </blockquote>
        </div>
      </div>
