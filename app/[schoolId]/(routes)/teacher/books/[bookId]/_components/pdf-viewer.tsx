    ...
    <div>
      <div className="flex gap-x-10">
        ...
        >
          ...
          <p className="mb-2 text-gray-500 font-semibold">Access online version pdf of the book</p>
      ...
      >
        ...
        <iframe
          ...
          src={`https://docs.google.com/viewer?srcid=${book.pdfLink}=explorer&efh=false&a=v&chrome=false&embedded=true`}
          width="1920px"
          height="1080px"
        ></iframe>
      </div>
      ...
      >
        ...
        <iframe
          className="w-screen h-screen"
          src={`https://docs.google.com/viewer?srcid=${book.guidePdfLink}=explorer&efh=false&a=v&chrome=false&embedded=true`}
          width="1920px"
          height="1080px"
        ></iframe>
      </div>
